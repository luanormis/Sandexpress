...
export const DEFAULT_PRODUCT_IMAGES: DefaultProductImage[] = [
  {
    ...
    description: 'Imagem padrão para cervejas long neck e garrafas.',
    plan_type: 'free',
  },
  {
    id: 'default-beer-can',
    ...
    description: 'Imagem padrão para cervejas em lata.',
    plan_type: 'free',
  },
  {
    ...
    description: 'Imagem padrão para drinks tropicais.',
    plan_type: 'free',
  },
  {
    id: 'default-soda',
    ...
    description: 'Imagem padrão para refrigerantes.',
    plan_type: 'free',
  },
  {
    id: 'default-juice',
    ...
    description: 'Imagem padrão para sucos naturais.',
    plan_type: 'free',
  },
  {
    id: 'default-fries',
    ...
    description: 'Imagem padrão para batata frita e porções.',
    plan_type: 'free',
  },
  {
    id: 'default-shrimp',
    ...
    description: 'Imagem padrão para camarão e frutos do mar.',
    plan_type: 'free',
  },
  {
    id: 'default-burger',
    ...
    description: 'Imagem padrão para hambúrguer e lanches.',
    plan_type: 'free',
  },
];
